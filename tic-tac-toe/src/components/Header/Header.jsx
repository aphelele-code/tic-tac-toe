...
const Header = () => {
  ...
  return (
    <HeaderWrapper>
     <svg onMouseEnter={playHoverSfx} onClick={() => {navigate('/')}} xmlns="http://www.w3.org/2000/svg" fill="#000000" width="100px" height="100px" viewBox="0 0 32 32" version="1.1">
...
<span onMouseEnter={playHoverSfx} onClick={() => toggleTheme()}> {theme === 'light' ? <DarkModeIcon/> : <LightModeIcon/>}</span>
